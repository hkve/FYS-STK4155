...
\subsection{Wisconsin Breast Cancer}
    ...
    \begin{figure}
        \begin{subfigure}{.49\textwidth}
            ...
            \caption{Showing accuracy as a function of learning rate, optimised using GD with and without momentum for 5 and 50 iterations.}
            \label[fig]{res:fig:logreg_GD_opt}
        \end{subfigure}
        \begin{subfigure}{.49\textwidth}
            \centering
            \includegraphics[width=\linewidth]{logreg_SGD.pdf}
            \caption{Showing accuracy as a function of learning rate, optimised plain, Adam and AdaGrad SGD while varying the number of epochs. For all optimisations, a batch size of 200 was used.}
            \label[fig]{res:logreg_SGD_opt}
        \end{subfigure}
    \end{figure}
