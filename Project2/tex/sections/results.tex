...
\subsection{Wisconsin Breast Cancer}
    ...
    The different optimisation algorithms from our library of gradient decent methods were applied to optimise the BCE cost function without penalisation \cref[eq]{the:eq:logreg_cost_function} using Logistic regression. This is presented in \cref[fig]{res:fig:logreg_GD_opt} for GD methods with out without momentum, while SGD based methods is presented in \cref[fig]{res:fig:logreg_SGD_opt}   
