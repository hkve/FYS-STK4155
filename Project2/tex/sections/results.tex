...
\subsection{Gradient Descent Analysis}
    ...
    \subsubsection{Ridge Optimisation}
        ...
        To see whether ridge actually had the potential to do a difference, we plotted the validation MSE of the analytical ridge solution as a function $\lambda$ against the analytical OLS solution in \cref{res:fig:ridge_ana}.
        ...
        \begin{figure}[ht!]
            ...
            \caption{Plot of the validation MSE found from optimising our linear regression parameters to the ridge cost function as a function of the penalisation parameter $\lambda$.}
...
\subsection{Wisconsin Breast Cancer}
    \begin{figure*}
        ...
        \begin{subfigure}{.49\textwidth}
            ...
            \caption{$\eta \in [ 0.001, 0.01 ]$ with $n = 50$ points. One hidden layer with 30 nodes}
            \label[fig]{res:fig:b}
        \end{subfigure}
        \hfill 
        \begin{subfigure}{.49\textwidth}
