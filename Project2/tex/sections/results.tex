...
\subsection{Wisconsin Breast Cancer}
    \begin{figure*}
        ...
        \begin{subfigure}{.49\textwidth}
            ...
            \label[fig]{res:fig:d}
        \end{subfigure}
        \caption{Plots of the accuracy score against learning rate for different activation functions for used for the hidden layer(s). Different network models have been used for the four plots. The AdaGrad algorithm with momentum $\gamma = 0.8$ has been used for optimisation.}
    \end{figure*}
