    ...
    \subsubsection{OLS Optimisation}
        ...
        \begin{table}[!ht]
            ...
            \begin{tabular}{r|c|l}
                ...
                AdaGrad SGD & $0.1762 \pm 0.0092$ & 0.70 \\
                AdaGrad Momentum SGD & $0.1762 \pm 0.0028$ & 0.30 \\
                RMSprop SGD & $0.1931 \pm 0.0060$ & 0.038 \\
                Adam SGD & $0.1736 \pm 0.0016$& 0.089 \\
            \end{tabular}
        ...
        \begin{figure*}
            ...
            \begin{subfigure}{.49\textwidth}
                ...
                \caption{The minimal MSEs by algorithm: RMSprop SGD 0.1931 ($\eta=0.038$), Adam SGD 0.1736 ($\eta=0.0016$), AdaGrad SGD 0.2031 ($\eta=0.70$), AdaGrad SGD w/ momentum 0.1762 ($\eta=0.31$)}
    ...
    \subsubsection{Ridge Optimisation}
        ...
        \begin{figure*}
            ...
            \begin{subfigure}{.49\textwidth}
                ...
                \caption{\textbf{SGD Adam}. Best MSE value was 0.1724 with $\lambda=0.001, \eta=0.090$}
