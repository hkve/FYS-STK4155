...
\subsection{Assessing Gradient Descent}
    ...
    \subsubsection{Ridge Regression}
        ...
        We selected four momentum based algorithms from the OLS analysis to see how they responded to changing of learning rate and $\lambda$-parameter in fitting to the validation data. Again we used 100 iterations for the GD method, and 100 epochs with batch size 64 with the SGD methods. Varying $\lambda \in [10^{-5}, 10^1]$, we compared first with a fixed learning rate between GD and SGD with momentum ($\gamma=0.8$). Then we used a tunable learning rate and SGD with AdaGrad with momentum ($\gamma=0.8$) and finally Adam $(\beta_1=0.9, \beta_2=0.99)$.
