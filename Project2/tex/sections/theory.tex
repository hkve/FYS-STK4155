...
\subsection{Gradient Descent Methods}
    ...
    \subsubsection{Improving Convergence Rate}
        ...
        \begin{align*}
            \vec{\theta}_{k} = \vec{\theta}_{k-1} - \frac{\eta}{\sqrt{\diag(G_k)}+\epsilon} \odot \vec{g}_k,
        \end{align*}
        ...
        \begin{align*}
            ...
            \vec{\theta}_k &= \vec{\theta}_{k-1} - \frac{\eta}{\sqrt{\vec{s}_k}+\epsilon} \odot \vec{g}_k
        \end{align*}
        ...
        \begin{align*}
            ...
            \vec{s}_k &= \beta_2 \vec{s}_{k-1} + (1-\beta_2) \vec{g}_k \odot \vec{g}_k \\
            \vec{\hat{m}}_k &= \frac{\vec{m}_k}{1-\beta_1^k} \\
            \vec{\hat{s}}_k &= \frac{\vec{s}_k}{1-\beta_2^k} \\
            \vec{\theta}_k &= \vec{\theta}_{k-1} - \frac{\eta}{\sqrt{\vec{\hat{s}}_k}+\epsilon} \odot \vec{\hat{m}}_k
        \end{align*}
