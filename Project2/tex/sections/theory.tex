...
When referring to the data we will be dealing without throughout this project, it is useful to define quantities clearly to limit the confusion. This was done in \cite{Project1}, but we will summarise it here.
