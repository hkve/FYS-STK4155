...
\subsection{Gradient Descent Methods}
    ...
    \subsection{Neural Networks}
        ...
        \subsubsection{Feed Forward}
            ...
            In the output layer the activation function constitutes what analysis the network does. E.g. a form of binary classification can be done by implementing the sigmoidactivation function in the output layer, and for regression problems the identity function, $f(x)=x$, is implemented.
...
\subsection{Classification}
    ...
    \subsubsection{Logistic regression}
        ...
        \end{align*}
        Finally, with $\vec{p}_i = \sigma(X_{ia}\theta_a)$, we can express the gradient of the BCE cost function in vector notation.
        \begin{align}
