...
\subsection{Gradient Descent Methods}
    ...
    \subsection{Neural Networks}
        ...
        \end{figure}
        In the output layer the activation function constitutes what analysis the network does. A logistic regression or other form of binary classification is done by implementing the sigmoid activation function in the output layer, and 
        It is normal that all the nodes in a layer have the same activation function $f$.    

        

        If we were to have a more complex neural network, also including hidden layers, $y$ would be a node in the layer after the input. Each such node would have its own activation bias and would be connected with the input through "unique" weights.  
