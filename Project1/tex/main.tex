...
\section{Method}
    ...
    \subsection{Resampling Techniques}
        ...
        \subsubsection{Bootstrap}
            ...
            When employing bootstrap it is important to find an appropriate number of rounds to preform the resampling. There is a tradeoff between getting an accurate distribution of the values and keeping the process computationally feasible. To find the optimal number of rounds we preform bootstrap on the Franke data for a variety of rounds while  calculating the MSE values. In this case we implement polynomial degree $7$ and bootstrap rounds at constant intervals from $30-1000$. There will be a distribution of MSE values for each number of rounds. By taking the mean of each distribution we can plot it as a function of rounds and find where it stabilises. One can argue that any number of rounds above this point will be excessive. We will also for each number of rounds plot the standard deviation of the corresponding MSE distribution divided by $\sqrt{L}$. 
