...
\section{Method}
    ...
    \subsection{OLS Revisited}
        ...
        \subsubsection{Bootstrap}
        \comment{Consider changing title name as not to match 3.4.1. -\Carl}
    ...
    \subsection{Ordinary Least Squares}
            ...
            \begin{figure*}
                \begin{subfigure}{\textwidth}
                    ...
                    \label{res:fig:OLS_beta_values_plot}
                \end{subfigure}
                \begin{subfigure}{\textwidth}
                    \centering
