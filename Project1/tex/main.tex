...
\section{Method}
    ...
    \subsection{Resampling techniques}
        ...
        \subsubsection*{Bootstrap}
            ...
            As well as the MSE, the bias and variance of the model are of the relevant measures for goodness of fit. When calculating these values it is important to calculate, not for each model, but across models. We are interested in the bias and variance of each point, not the entire models (see equations \ref*{theo:eq:}).
