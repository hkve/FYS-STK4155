...
\section{Method}
    The code used to performed the following analysis can be found at \url{https://github.com/hkve/FYS-STK4155/tree/main/Project1}.
    ...
    First, we should introduce the datasets we will be working with.
        ...
        \subsubsection{Terrain Data}
            We chose to sample terrain data from a mountainous region in northwestern Nicaragua, close to the border to Honduras, shown in Figure~\ref{met:fig:gmaps}.
...
\section{Results}
    \subsection{Ordinary Least Squares}
            \subsubsection{Without Resampling}
                ...
                \begin{figure}[ht]
                    \centering
                    \includegraphics[width=.9\linewidth]{nores_OLS_R2_noresample.pdf}
            ...
            \begin{figure*}
                \begin{subfigure}{\textwidth}
                    \centering
                    \includegraphics[width=\linewidth]{nores_OLSOLS_coefs_plots.pdf}
                ...
                \begin{subfigure}{\textwidth}
                    \centering
                    \includegraphics[width=\linewidth]{nores_OLSOLS_coefs_table.pdf}
        ...
        \subsubsection{Applying Resampling}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=.9\linewidth]{BS_Bias_var_OLS.pdf}
            ...
            \begin{figure}[H]
                ...
                %     \centering
                %     \includegraphics[width=.9\linewidth]{BS_Bias_var_decomp_OLS_600_data_points.pdf}
                %     \caption{$n=600$}
                % \end{subfigure}
                \begin{subfigure}{\linewidth}
                    \centering
    ...
    \subsection{Ridge and Lasso}
        ...
        \begin{figure}[ht]
            \begin{subfigure}{\linewidth}
                \centering
                \includegraphics[width=.9\linewidth]{good_lmbda_Ridge_mse_kfold.pdf}
            \end{subfigure}
            \hfill
            \begin{subfigure}{\linewidth}
                \centering
                \includegraphics[width=.9\linewidth]{good_lmbda_Lasso_mse_kfold.pdf}
            \end{subfigure}
        ...
        \subsubsection{Bias-Variance Decomposition}
            ...
            \begin{figure}[ht]
                \begin{subfigure}{\linewidth}
                    \centering
                    \includegraphics[width=.9\linewidth]{BS_Bias_var_Ridge.pdf}
                \end{subfigure}
                \begin{subfigure}{\linewidth}
                    \centering
                    \includegraphics[width=.9\linewidth]{BS_Bias_var_Lasso.pdf}
                \end{subfigure}
    ...
    \subsection{Nicaraguan Terrain Data}
        ...
        \begin{figure} [ht]
            \centering
            \includegraphics[width=.9\linewidth]{HM_Nica_Ridge_heatmap.pdf}
            \includegraphics[width=.9\linewidth]{HM_Nica_Lasso_heatmap.pdf}
