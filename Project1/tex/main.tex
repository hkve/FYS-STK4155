...
\section{Results}
    ...
    Initially, we fit the OLS method to the terrain data with $p\in[5, 25]$. 
        ...
        \begin{figure} [H]
            ...
            \end{subfigure}
            \caption{Comparison of the actual Nicaraguan terrain test data and the unscaled prediction of our best scoring model. $x$ denotes arcseconds north, $y$ denotes arcseconds west. $z$ units can be disregarded, but scale serves to allow comparison of magnitude between the plots.}
