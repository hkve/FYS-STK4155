    ...
    \subsection{Ordinary Least Squares}
            ...
            \begin{figure*}
                \begin{subfigure}{\textwidth}
                    \centering
                    \includegraphics[width=.9\linewidth]{OLS_coefs_plots.pdf}
                ...
                \begin{subfigure}{\textwidth}
                    \centering
                    \includegraphics[width=.9\linewidth]{OLS_coefs_table.pdf}
