...
\section{Method}
    ...
    \subsection{Resampling techniques}
        ...
        \subsubsection*{Bootstrap}
            ...
            When utilising bootstrap it is important to find an appropriate number of rounds to preform the resampling. There is a trade-off between getting an accurate distribution of the values and keeping the process computationally feasible. To find the optimal number of rounds we preform bootstrap on the Franke data for various number of rounds, calculate the MSE values and plot the results. 
