...
\section{Results}
    ...
    Initially, we fit the OLS method to the terrain data with $p\in[5, 25]$. 
        \begin{figure} [ht]
            ...
            \caption{Optimisation of the MSE of OLS on the terrain data using $k=7$ cross validation. The thinner lines denote the MSE by fold, and the thicker line the mean. Mininum at $p=12$ with $\mse = 0.1808$.}
