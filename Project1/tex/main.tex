...
Something general about initially fitting Franke data using OLS, ridge and lasso. Then moving on to real terrain data something something.
    ...
    \comment{not sure about how we should divide these subsections, but I wanted to write a bit about data scaling - \Carl. Since we compose this design matrix and preform scaling for all models, mabye give this section a  more general name and write about train test splitting}
...
\section{Results}
    \comment{Not sure about section ordering here - \Hakon}
    \subsection{Ordinary least squares}
