...
<<<<<<< HEAD
            ...
            When employing bootstrap it is important to find an appropriate number of rounds to preform the resampling. There is a tradeoff between getting an accurate distribution of the values and keeping the process computationally feasible. To find the optimal number of rounds we preform bootstrap on the Franke data for a variety of rounds while  calculating the MSE values. There will be a distribution of MSE values for each number of rounds. By taking the mean of each distribution we can plot it as a function of rounds and find where it stabilises. One can argue that any number of rounds above this point will be excessive. 
=======
...
<<<<<<< HEAD
            When employing bootstrap it is important to find an appropriate number of rounds to preform the resampling. There is a trade-off between getting an accurate distribution of the values and keeping the process computationally feasible. To find the optimal number of rounds we preform bootstrap on the Franke data for a variety of rounds while  calculating the MSE values. In this case we implement polynomial degree $7$ and bootstrap rounds from $30-1000$. There will be a distribution of MSE values for each number of rounds. By taking the mean of each distribution we can plot it as a function of rounds and find where it stabilises. One can argue that any number of rounds above this point will be excessive. 
>>>>>>> f53594088f8380ffb7a05a3fcc064f8794bf6e91
=======
            When employing bootstrap it is important to find an appropriate number of rounds to preform the resampling. There is a trade-off between getting an accurate distribution of the values and keeping the process computationally feasible. To find the optimal number of rounds we preform bootstrap on the Franke data for a variety of rounds while  calculating the MSE values. In this case we implement polynomial degree $7$ and bootstrap rounds at consant intervals from $30-1000$. There will be a distribution of MSE values for each number of rounds. By taking the mean of each distribution we can plot it as a function of rounds and find where it stabilises. One can argue that any number of rounds above this point will be excessive. We will also for each number of rounds plot the standard deviation of the corresponding MSE value distribution divided by the number of rounds to visualise variation. 
>>>>>>> 963a9e7c944c3db33ed53c9874ec6f0a6c075a4b
...
\section{Discussion}
    ...
    \subsection{Bias-Variance Tradeoff}
        \comment{More general discussion here}\\

        \comment{$\lambda$-specific here}\\
        In Figure~\ref{res:fig:bs_bias_var_lmbdas_Ridge_Lasso} we see
