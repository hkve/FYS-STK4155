...
\section{Theory}
    ...
    \subsubsection{New section for MSE}
        ...
        \begin{align}
            ...
            \label{eq:theo:r2}
        \end{align}
        \comment{Mabye something about $R^2 \in (-\infty, 1]$, where $R^2 = 1$ is a perfect fit, $R^2 = 0$ is equal to predicting the mean $\bar{y}$ all the time and $R^2 < 0$ is even worse. - $\mathcal{H}$}
