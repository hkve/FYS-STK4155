    ...
    \section{Findings and Discussion}
        ...
        \end{figure}
        Even though a single tree did not perform well, an ensemble of trees can often give better results. Varying the number of trees in our ensemble, both the bagged trees and random forest can be seen in \cref{fig:bag_and_rf_biasvar_decomp}.  
        \begin{figure}[H]
            \centering
