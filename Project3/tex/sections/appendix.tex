    ...
    \section{Findings and Discussion}
        ...
        \subsection{Summarising Results}
            Through a study of the bootstrapped estimates for test MSE, bias and variance applied to player scores from FIFA21, we found that penalised      
        
        The penalised linear regression models performed  