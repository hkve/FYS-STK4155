    ...
    \section{Findings and Discussion}
        ...
        \subsection{Support Vector Machines}
        Lastly, we investigate how our SVM performs when increasing the margin ($\epsilon$). To assure convergence, the margin is slightly soft, setting $C = 1$. The results from both the linear and RBF kernel can be seen in \cref{fig:SVR_eps}. 
        \begin{figure}[H]
            \centering
