...
\subsection{Architecture tuning}
    ...
    \subsubsection{Hyperband Search}
        ...
        These $k$ models are then trained further, with a new $n=k$ and more resources $r$. This halving is then repeated until there is one model remaining. As such, as hyperparameter points are discarded ($n$ decreases), the amount of allocated resources $r$ increases; meaning the more promising hyperparameter points are allotted exponentially more resources.
