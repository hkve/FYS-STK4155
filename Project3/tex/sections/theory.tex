...
\comment{not sure where to put this yet (also winging the notation until we meet) -\Johan}
    ...
    \comment{Move covariance def. to appendix -\Johan}
    ...
    \comment{will actually rewrite this with (n,m) convention, and agreed upon notation -\Johan}

    \comment{draft for gooder version below}
    ...
    \comment{explain the meaning of the diagonal elements of $S_Y$}
