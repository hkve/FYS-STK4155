...
\subsection{Local Winner-Takes-All (LWTA)}
    ...
    \subsection{Neurological Background}
        ...
        \subsubsection{Function}
            ...
            Competative mechanisms can account for: how the brain respond differently to various incoming signals; feature selection; . 

        \subsubsection{Connect to ML}
            Visual perception. 
